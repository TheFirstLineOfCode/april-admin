...
import {fetchUtils, useTranslate, Title, useDataProvider, useNotify} from 'react-admin'
import {notifyFetchError} from 'april-react-admin'
...
export const TestDataView = () => {
	...
	if (state == TOTALS_NOT_FETCHED) {
		return (
			<>
				<Title title="application.title.testData" />
